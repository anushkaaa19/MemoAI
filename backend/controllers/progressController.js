...
export const getDashboard = async (req, res, next) => {
    try {
        ...
        // Calculate study streak (example logic - you can enhance this)
        // This is a placeholder - you can implement actual streak calculation
        // based on user's activity dates

        // Recent activity - documents
        const recentDocuments = await Document.find({ userId })
            .sort({ lastAccessed: -1 })
            .limit(5)
            .select('title createdAt lastAccessed');
