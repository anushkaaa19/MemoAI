...
const DashboardPage = () => {
  ...
  useEffect(() => {
    ...
    fetchDashboardData(); // ⚠️ You were missing this function call!
  ...
  if(!dashboardData||!dashboardData.overview){
    // Render your actual dashboard UI here
    return (
                      ...
                      <div className="flex items-center gap-2 mb-1">
                        <div
                          className={`w-2 h-2 rounded-full ${
                            activity.type === 'document' ? 'bg-gradient-to-r from-blue-400 to-cyan-500' : 'bg-gradient-to-r from-emerald-400 to-teal-500'
                          }`}
                        />
