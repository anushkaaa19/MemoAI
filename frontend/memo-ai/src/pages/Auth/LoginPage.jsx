...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-slate-50 via-white to-slate-50">
      <div className="absolute inset-0 bg-[radical-gradient(#e5r7eb_1px,transparent_1px)] bg-size-[16px_16px] opacity-30"></div>
        ...
        <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10'>
          ...
          <div className="mt-8 pt-6 border-t border-slate-200/60">
            <p className="text-center text-sm text-slate-600">
              ...
              <Link to='/register' className="text-emerald-600 hover:text-emerald-700 transition-colors duration-200 font-semibold">
                Sign up
              </Link>
            </p>
